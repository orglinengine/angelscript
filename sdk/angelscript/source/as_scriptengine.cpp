...
int asCScriptEngine::SetEngineProperty(asEEngineProp property, asPWORD value)
{
	...
	// ORGLIN: script classes are implicit-handle types (ADR-0010 slice 3).
	...
	// ORGLIN: `{ key = value }` list literal entries (ADR-0011).
...
asPWORD asCScriptEngine::GetEngineProperty(asEEngineProp property) const
{
	...
	// ORGLIN: implicit-handle script classes.
	case asEP_IMPLICIT_HANDLE_CLASSES:
	...
	// ORGLIN: dictionary list literal entries.
	case asEP_DICTIONARY_LITERALS:
